    ...
    <AccordionPrimitive.Header className="flex">
      ...
      >
        ...
        <span className="ml-2">
          ...
          {open ? (
            <FaMinusCircle className="h-8 w-8 text-blueAlt transition-transform duration-200" />
          ) : (
            <BsFillPlusCircleFill className="h-8 w-8 text-blueAlt transition-transform duration-200" />
          )}
        </span>
      </AccordionPrimitive.Trigger>
